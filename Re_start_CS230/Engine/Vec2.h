...
namespace math
{
    ...
    struct vec2
    {
        ...
        [[nodiscard]] constexpr vec2 operator*=(const vec2& v1)noexcept;
        [[nodiscard]] constexpr vec2 operator*=(const double Num) noexcept;
    ...
    struct ivec2
    {
        ...
        [[nodiscard]] constexpr ivec2 operator-=(const ivec2& v1)noexcept;
        [[nodiscard]] constexpr ivec2 operator*=(const ivec2& v1)noexcept;
        [[nodiscard]] constexpr ivec2 operator*=(const int Num) noexcept;
        [[nodiscard]] constexpr ivec2 operator/=(const ivec2& v1)noexcept;
        [[nodiscard]] constexpr ivec2 operator/=(const int Num)noexcept;
    ...
    [[nodiscard]] constexpr ivec2 operator-(const ivec2& v1, const ivec2& v2) noexcept;
    [[nodiscard]] constexpr ivec2 operator/(const ivec2& v1, const ivec2& v2) noexcept;
    /*constexpr ivec2 operator/(const ivec2& v1, const int Num) noexcept;*/
